...
export function ClientsSection({ eyebrow, heading, companies }: ClientsSectionProps) {
  ...
  return (
    <section
      ...
      className="landing-section-transition mx-auto flex w-full max-w-full flex-col items-center justify-end gap-16 bg-white px-5 py-16 sm:px-8 lg:gap-[6rem] lg:px-[3.5rem] lg:py-[6.25rem]"
    >
