...
export function ServicesSection({ eyebrow, heading, services }: ServicesSectionProps) {
  ...
  return (
    <section
      ...
      className="landing-section-transition mx-auto flex w-full max-w-[90rem] flex-col items-center justify-end gap-16 bg-white px-5 py-16 sm:px-8 lg:gap-[6.25rem] lg:px-[3.5rem] lg:py-[6.25rem]"
    >
