...
export const contactPageType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "forms",
      description:
        "Options shown in the general enquiry form.",
    ...
    defineField({
      ...
      title:
        "Partnership enquiry categories",
      type: "array",
      group: "forms",
      description:
        "Options shown in the partnership enquiry form.",
    ...
    defineField({
      ...
      group: "careersCta",
      description:
        "If empty, the website uses the local image3.png image.",
    }),
  ],
  ...
  preview: {
    prepare: () => ({
      title: "Contact Page",
      subtitle:
        "Contact pathways and connected-world content",
    }),
  },
});