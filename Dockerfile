...
ARG NEXT_PUBLIC_LEGAL_NAME="Suman Entertainment & Media Pvt. Ltd."
ARG NEXT_PUBLIC_ALLOW_INDEXING=true
ARG NEXT_PUBLIC_SANITY_PROJECT_ID
ARG NEXT_PUBLIC_SANITY_DATASET=production
ARG NEXT_PUBLIC_SANITY_API_VERSION=2026-08-21
ARG NEXT_PUBLIC_SANITY_STUDIO_PREVIEW_URL=http://localhost:3000
...
ENV NEXT_PUBLIC_SANITY_STUDIO_PREVIEW_URL=$NEXT_PUBLIC_SANITY_STUDIO_PREVIEW_URL
